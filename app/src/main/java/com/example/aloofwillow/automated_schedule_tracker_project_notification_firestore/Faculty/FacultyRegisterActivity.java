            ...
            mAuth.createUserWithEmailAndPassword(EmailTxt, PassTxt).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(FacultyRegisterActivity.this, "Error "+task.getException(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
            startActivity(new Intent(FacultyRegisterActivity.this, FacultyMainActivity.class));
            finishAffinity();
        } else {
            Toast.makeText(FacultyRegisterActivity.this, "Registration Error", Toast.LENGTH_SHORT).show();
            progressBar.setVisibility(View.INVISIBLE);
        }

    }
    void sendToMain(){
        Intent intent=new Intent(FacultyRegisterActivity.this,FacultyMainActivity.class);
