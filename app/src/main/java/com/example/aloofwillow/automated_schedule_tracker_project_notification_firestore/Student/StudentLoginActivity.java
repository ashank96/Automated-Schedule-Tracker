        ...
        submit.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(EmailTxt) && !TextUtils.isEmpty(PassTxt)) {
                    ...
                    auth.signInWithEmailAndPassword(EmailTxt,PassTxt).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()){
                                ...
                                firebaseFirestore.collection("Students").document(user_id).update(tokenMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                ...
                                Toast.makeText(StudentLoginActivity.this,"Incorrect email or password",Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(StudentLoginActivity.this, "Some fields are still empty", Toast.LENGTH_SHORT).show();
                }
            }
        });
